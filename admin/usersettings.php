...
if ($_POST['actionType'] == 'deleteUser') {
  if (!deleteUser($userObject['id'])) {
    ...
    print "<script>location.href='" . BASE_PATH . "/auth/logout.php';</script>";
  }
}
if ($_POST['actionType'] == 'changePassword') {
  if (!changePassword($userObject['id'], array(
...
<?php if (!$isAndroid) { ?>
  ...
  <div style='width:100%;text-align:center;margin-top:10px;'>
    <a href='index.php'><?php print translate("vissza_a_fooldalra") ?></a>
  </div>
  ...
  <form id="formUserSettings" method='POST'>
    ...
    <table style='border:solid #000000 1px' align='center' bgcolor='#FAFAFA'>
      <tr>
        <td>
          <table border='0' cellpadding='4' style='font-size:11px;'>
            <tr>
              <td colspan='2' style=<?php print "'color:" . $globalcolor . ""; ?>;font-size:12px' align='center'>
                <font size='5'>
      ...
      \"></td></tr>";
            ?>
            <tr>
              <td><?php echo translate("oldPassword"); ?>: </td>
              <td><input type='text' size='15' name='oldPassword' value=''></td>
            </tr>
            <tr>
              <td><?php echo translate("newPassword"); ?>: </td>
              <td><input type='text' size='15' name='newPassword' value=''></td>
            </tr>
            <tr>
              <td><?php echo translate("confirmNewPassword"); ?>: </td>
              <td><input type='text' size='15' name='confirmNewPassword' value=''>
              </td>
            </tr>
            <tr>
              <td colspan='2' valign='top' align='center' style='padding-bottom:40px;'>
                <?php
...
<?php   } else { ?>
  ...
  <div style='width:100%;text-align:center;margin-top:30px;margin-bottom:20px;'>
    <a href='index.php' style='font-size:40px'><?php print translate("vissza_a_fooldalra") ?></a>
  </div>
  ...
  <form id="formUserSettings" method='POST'>
    ...
    <table style='border:solid #000000 1px' align='center' bgcolor='#FAFAFA'>
      ...
      \"></td></tr>";
            ?>
            <tr>
              <td style=<?php print "'color:" . $globalcolor . ";font-size:50px'"; ?>><?php echo translate("oldPassword"); ?>: </td>
              <td><input style='font-size:50px;' type='text' size='15' name='oldPassword' value=''></td>
            </tr>
            <tr>
              <td style=<?php print "'color:" . $globalcolor . ";font-size:50px'"; ?>><?php echo translate("newPassword"); ?>: </td>
              <td><input type='text' style='font-size:50px;' size='15' name='newPassword' value=''></td>
            </tr>
            <tr>
              <td style=<?php print "'color:" . $globalcolor . ";font-size:50px'"; ?>><?php echo translate("confirmNewPassword"); ?>: </td>
              <td><input type='text' style='font-size:50px;' size='15' name='confirmNewPassword' value=''>
              </td>
            </tr>
            <tr>
              <td colspan='2' valign='top' align='center' style='padding-bottom:40px;'>
