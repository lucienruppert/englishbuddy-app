    ...
    <form method='POST' action='subMain.php'>
        <table width='100%'>
            <tr>
                ...
                <td width='20%'>
                    <input type='button' name='orderButton' value='V�lt�s' onclick="
...
">&nbsp;&nbsp;
                    ...
                    <div id='allWords' style='width:250;height:550;overflow:auto;scrollbar-track-color:white;scrollbar-face-color:silver;scrollbar-highlight-color:black;scrollbar-shadow-color:gray'>
                        <table>
                            <?php
                            ...
                            $words = getAllWordsWithLevelExceptions(array(8), $_REQUEST['orderLang'], $_SESSION['userObject']['nyelv']);
