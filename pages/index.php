<?php
include_once(__DIR__ . '/../includes/topPHP.php');
...
<HEAD>
    ...
    <link rel="shortcut icon" type="image/x-icon" href="<?php print BASE_PATH; ?>/images/white.ico">
