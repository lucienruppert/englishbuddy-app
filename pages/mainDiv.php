    ...
    <div class="navigation-mainDiv">
      ...
      <span style="display:<?php echo $_SESSION['isShown'] ? 'none' : 'flex'; ?>" class="welcome submenu">
        <div class="dropdown" style="display:inline-block;">
          <a href="#" class="medium-color" onclick="event.preventDefault();var m=document.getElementById('mondatgyakorlas-submenu');if(m)m.classList.remove('show');var s=document.getElementById('szogyakorlas-submenu');if(s)s.classList.toggle('show');"><?php print translate('szo_gyakorlas'); ?> &#9662;</a>
          <div id="szogyakorlas-submenu" class="dropdown-content" style="display:none;position:absolute;z-index:100;background:white;border:1px solid #334155;padding:5px 0;border-radius:6px;min-width:160px;">
            <a href="#" class="medium-color" onclick="var s=document.getElementById('szogyakorlas-submenu');if(s)s.classList.remove('show');sajatSzavak();"><?php print translate('increasevocabulary'); ?></a>
            <a href="#" class="medium-color" onclick="var s=document.getElementById('szogyakorlas-submenu');if(s)s.classList.remove('show');alapszokincs();"><?php print translate('basicvocabulary'); ?></a>
          </div>
        </div>
        <div class="dropdown" style="display:inline-block;margin-left:20px;">
          <a href="#" class="medium-color" onclick="event.preventDefault();var s=document.getElementById('szogyakorlas-submenu');if(s)s.classList.remove('show');var m=document.getElementById('mondatgyakorlas-submenu');if(m)m.classList.toggle('show');">Mondatgyakorlás &#9662;</a>
          <div id="mondatgyakorlas-submenu" class="dropdown-content" style="display:none;position:absolute;z-index:100;background:white;border:1px solid #334155;padding:5px 0;border-radius:6px;min-width:180px;">
            <a href="#" class="medium-color" onclick="var m=document.getElementById('mondatgyakorlas-submenu');if(m)m.classList.remove('show');peldamondatok();">Nyelvtani Példatár</a>
            <a href="#" class="medium-color" onclick="var m=document.getElementById('mondatgyakorlas-submenu');if(m)m.classList.remove('show');intelligensGyakorlo();">Intelligens gyakorló</a>
            <a href='#' class="medium-color" <?php print 'onclick=' . $onclick1 . ';'; ?>>Saját Mondatok</a>
            <a href="#" class="medium-color" onclick="var m=document.getElementById('mondatgyakorlas-submenu');if(m)m.classList.remove('show');osszgyakorlo();">Összgyakorló</a>
          </div>
        </div>
        <style>
          .dropdown-content a {
      ...
      <?php if ($userObject && !in_array($userObject["status"], array(1, 2))) { ?>
        ...
        <a class="medium-color show-menu" onclick="audioSzoba();" href="#"><?php print translate("audioszoba"); ?></a>
        <?php
  ...
  <table width='100%' align='center' valign='center' style=<?php print "'border: 1px solid " . $globalcolor . ";'"; ?> cellpadding='0' cellspacing='0'>
    ...
    <tr>
      <td colspan='3' valign='center' align='center' style=<?php print "'padding-bottom:10px;font-size:14pt;color:white;border-bottom: 1px solid " . $globalcolor . ";background:" . $globalcolor . ";'"; ?>>
        <?php print translate("legujabb_szavak"); ?>
      </td>
    </tr>
    <tr>
      <?php
          ...
          <table border='0' align='center' valign='center' style=<?php print "'border: 1px solid " . $globalcolor . ";'"; ?> cellpadding='0' cellspacing='0'>
            ...
            <tr>
              <td colspan='3' valign='center' align='center' style=<?php print "'padding-bottom:10px;font-size:20pt;color:white;border-bottom: 1px solid " . $globalcolor . ";background:" . $globalcolor . ";'"; ?>>
                <?php print translate("myperformance"); ?></td>
            </tr>
            <tr>
              <?php
