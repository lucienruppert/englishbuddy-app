...
<div class="navigation-menu">
  ...
  if (is_array($upperRowObject) && !in_array($userObject["status"], array(1, 2))) {
    foreach ($upperRowObject as $currentItem) {
      ...
      $filePath = '../' . $currentItem['langs'][$userObject['nyelv']][$userObject['forras_nyelv']];
      $content = str_replace('{include_file}', file_get_contents($filePath), $currentItem['content']);
      print $content;
    }
  }
  ?>
...
function getLinksForPractice()
{
  ...
  /*if(!$GLOBALS['isAndroid'])*/ {
    ...
    $obj['igeragozas']['langs'][2][0] = 'conjugation/verbos_eng.html';
    $obj['igeragozas']['langs'][2][1] = 'conjugation/verbos_eng.php';

    $obj['igeragozas']['langs'][3][0] = 'conjugation/conjugation_arab3.php';
    ...
    $obj['abc']['langs'][2][0] = 'modules/abc.html';
    $obj['abc']['langs'][2][1] = 'modules/abc.html';
    ...
    $obj['kiejtes']['langs'][2][0] = 'modules/kiejtes.html';
    $obj['kiejtes']['langs'][2][1] = 'modules/kiejtes.html';

    $obj['kiejtes']['langs'][3][0] = 'conjugation/hardsounds_arab.php';
    ...
    $obj['szorend']['langs'][2][0] = 'modules/szorend_sp.html';
    $obj['szorend']['langs'][2][1] = 'modules/szorend_sp.html';

    $obj['szorend2']['content'] = "<td id='szorend2' style=\"font-weight:normal;\"><a href='#' class='hide-on-mobile' onmouseover=\"document.getElementById('szorendtable2').style.display = 'block';\"
    ...
    $obj['szorend2']['langs'][1][0] = 'modules/szorend.html';
    $obj['szorend2']['langs'][1][2] = 'modules/szorend_esp.html';

    $obj['szorend2']['langs'][4][0] = 'modules/szorend_ger.html';

    $obj['nevmasok']['content'] = "<td id='nevmasok'><a href='#' class='hide-on-mobile' style=\"font-weight:normal;\" onmouseover=\"document.getElementById('nevmasoktable').style.visibility = 'visible';\" onmouseout=\"document.getElementById('nevmasoktable').style.visibility = 'hidden';\">" . translate('nevmasok') . "</a>
                                        <div id='nevmasoktable' class='hide-on-mobile'>{include_file}</div></td>";
    $obj['nevmasok']['langs'][1][0] = 'conjugation/nevmasok_eng.html';
    $obj['nevmasok']['langs'][1][2] = 'conjugation/nevmasok_eng_esp.html';
    $obj['nevmasok']['langs'][2][0] = 'conjugation/nevmasok.html';
    $obj['nevmasok']['langs'][2][1] = 'conjugation/nevmasok.html';
    $obj['nevmasok']['langs'][3][0] = 'conjugation/nevmasok_arab.php';
    $obj['nevmasok']['langs'][4][0] = 'conjugation/nevmasok_ger.html';

    $obj['rendhagyo']['content'] = "<td id='nevmasok'><a href='http://www.englishpage.com/irregularverbs/irregularverbs.html' class='hide-on-mobile' style=\"font-weight:normal;\" target='_blank'  >" . translate('rendhagyo_igek') . "</a></td>";
    $obj['rendhagyo']['langs'][1][0] = 'conjugation/nevmasok_eng.html';
    $obj['rendhagyo']['langs'][1][2] = 'conjugation/nevmasok_eng_esp.html';
  }
