<?php
    ...
    if($saved){
        $fillId = saveQuestFill($_POST[133], 2);
        ...
        header('Location: https://yourhealth.store/koszonjuk-valaszaidat/');
        exit;
    }
...
<td>
    ...
    <tr><td style='padding-top:20px;font-size:20pt;text-align:center;color:#000000'>Your Health Academy</td></tr>
    ...
    <tr><td style='padding-top:20px;text-align:center;font-size:9pt'>&copy; A felmérés a Your Health Academy szellemi tulajdona. Minden jog fenntartva.</td></tr>
    </table>
...
<input style='padding-top:20px;padding-bottom:20px;padding-left:50px;padding-right:50px;font-size:25px;font-weight:bold;color:#ffffff;background: rgba(27, 90, 9,1)' type='button' name='btnNewDesire' value='ELKÜLD' onclick="$(this).prop('disabled', true);with(document.forms[0]){ submit(); }">
</td>
</tr>
</table>
</div>
