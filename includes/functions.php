...
$GLOBALS['dark'] = "#334155"; // slate-700 color
$GLOBALS['highlight'] = "white"; // changed from orange to white
...
?>
        ...
        function getMoreMeaningDivContent(responseObject) {
            ...
            if (responseObject.items.length > 0) {
                ...
                for (var i = 0; i < responseObject.items.length; i++) {
                    ...
                    <?php } ?>
                    if (responseObject.items[i].level_category == 1) {
                        str += "</td><td><span class='btnAjaxDivSave' style='color:<?php print $globalcolor; ?>;' onclick='event.stopPropagation();setUserWordById(" + responseObject.items[i].id + ")'>" + <?php print "'" . translate("ajaxDivSave") . "'"; ?> + "</span>";
                    }
                    str += "</td></tr>";
                }
            }
    ...
    <table id="ajaxTable" border='0' align='center' cellpadding='3' cellspacing=0 onclick="event.stopPropagation();" style="width:800px">
        <tr>
            ...
            <td style='<?php print $GLOBALS['TDBgGlobalColor']; ?>;width:150px;' align='left'>
                <div class='ajaxSearchTxtContainer'>
                    ...
                    var val = this.value;
                    searchTimeout = setTimeout(function() { eval(getTimeoutTextAjax(val)); }, 3000);
                    " />
                </div>
            </td>
            ...
            <td align='left' colspan='2' valign='center' height='30' style='<?php print $GLOBALS['TDBgGlobalColor']; ?>color:<?php print $GLOBALS['globalcolor']; ?>'><b>
    ...
    <div id='ajax_other_langs' style='<?php echo $GLOBALS['TDBgGlobalColor']; ?>color:white;position:absolute;top:10px;left:50%;margin-left:-190px;width:550px;filter:alpha(opacity=100);opacity:1;z-index:101;font-size:10pt;'></div>
<?php
}
