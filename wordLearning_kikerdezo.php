...
if (!isset($_SESSION['wordLearning_kikerdezo']) || !is_array($_SESSION['wordLearning_kikerdezo']) || (isset($_REQUEST['source']) && $_REQUEST['source'] == 'welcome')) {
...
// Initialize $audio_part to avoid undefined variable warning
$audio_part = "";
if ($isNeedAudioPart) {
    // Uncomment and use the following if you want to enable audio part
...
<div name='quickLearning' id='quickLearning'>
    <table border='0' width='800' cellspacing=0 cellpadding=0>
        ...
        <tr>
            <td align='center' height='50' valign='center' style='width:100%;font-size:20pt;color:white;background-color:grey'>Sz�t�rfelt�lt�s</td>
        </tr>
        <tr>
        ...
        <tr>
            <td align='center' valign='top' style='height:40px;' onclick="event.stopPropagation();">
                <a href='#' style=<?php print "'font-size:10pt;color:" . $globalcolor . ";font-weight:bold;'"; ?> onclick="event.stopPropagation();storeWord();">R�GZ�TEM A SZ�T�RAMBA</a>
            </td>
        </tr>
    </table>
</div>
