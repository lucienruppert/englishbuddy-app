...
$tdValue = "background-color:$medium";
$colorValue = "$medium";
...
?>
    ...
    <div id='moreMeaningDiv' style='position:absolute;left:50%;margin-left:-250px;width:500px;display:none;z-index:100;background: red none repeat scroll 0 0;' onclick="event.stopPropagation();this.style.display = 'none';$('#linkSave').hide();$('#ajaxSearchOutput').hide();"></div>
