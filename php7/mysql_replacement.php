...
// Schlie�t eine Verbindung zu MySQL
...
// �ffnet eine Verbindung zu einem MySQL-Server
...
// Selektiert ein Schema und f�hrt in ihm Anfrage aus
...
// Liefert den Fehlertext der zuvor ausgef�hrten MySQL Operation
...
{
	global $vts_mysqli;
	return $vts_mysqli->escape_string($unescaped_string);
}
...
// Liefert die L�nge eines jeden Feldes in einem Ergebnis
...
// Liefert die L�nge des angegebenen Feldes
...
// Liefert den Namen der Tabelle, die das genannte Feld enth�lt
...
// Auflistung der verf�gbaren Datenbanken (Schemata) auf einem MySQL Server
...
function mysql_query($query, $link_identifier = NULL)
{
	...
	return $li->query($query, MYSQLI_STORE_RESULT);
}

// Maskiert spezielle Zeichen innerhalb eines Strings f�r die Verwendung in einer SQL-Anweisung
