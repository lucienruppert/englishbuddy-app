...
if ($showNumber != $KESZ_UGYES_VAGY) {
    ...
    print "<table><tr>";
    print "\n<td align='center' valign='center' style='background-color:white;padding:0;cursor:pointer;width:150px;height:70px;border-radius:20px;display:table-cell;vertical-align:middle;' onclick=\"event.stopPropagation();betu1_Click();\"><span style=" . $nemtudtamFontSize . ">" . translate('betu1') . "</span></td>";
    print "\n<td style='width:20px;'></td>"; // Gap between buttons
    print "\n<td align='center' valign='center' style='background-color:white;padding:0;cursor:pointer;border-radius:20px;width:150px;height:70px;display:table-cell;vertical-align:middle;' onclick=\"event.stopPropagation();location.href='main.php?content=wordLearning_quick&inbetween=1&stillPract=1';\"><span style=" . $nemtudtamFontSize . ">" . translate('nem_tudtam') . "</span></td>";
    if ($clickSource != "sentencePractice" && $clickSource != "basicWordPractice" && $clickSource != "sentencePractice2" && $clickSource != "intelligent") {
        print "\n<td style='width:20px;'></td>"; // Gap between buttons
        print "\n<td align='center' valign='center' class='show-button' style='background-color:white;padding:0;cursor:pointer;width:150px;height:70px;border-radius:20px;display:table-cell;vertical-align:middle;' onclick=\"event.stopPropagation();mumus2_Click();\"><span style=" . $nemtudtamFontSize . ">" . translate('mumus2') . "</span></td>";
        print "\n<td style='width:20px;'></td>"; // Gap between buttons
        print "\n<td align='center' valign='center' class='show-button' style='background-color:white;padding:0;cursor:pointer;width:150px;height:70px;border-radius:20px;display:table-cell;vertical-align:middle;' onclick=\"event.stopPropagation();remove_Click();\"><span style=" . $nemtudtamFontSize . ">" . translate('remove') . "</span></td>";
    }
    print "</tr>";
    print "</table>";
    print "</td>";
} else {
    print "<td align='center' valign='center' style='padding-top:10px;padding-bottom:10px;' onclick=\"event.stopPropagation();\">";
    if ($clickSource != "intelligent")
        print "\n<div align='center' valign='center' style='background-color:white;padding:0;cursor:pointer;width:150px;height:70px;border-radius:20px;display:table-cell;vertical-align:middle;margin:0 auto;' onclick=\"event.stopPropagation(); location.href='main.php?content=wordLearning_quick&againPractise=1&packageStart=1';\"><span style=" . $nemtudtamFontSize . ">" . translate("meg_egyszer") . "</span></div><br><br>";
