...
<tr><td align='left' colspan='2' style='padding-top:10%;padding-bottom:30px;font-size:<?php print($SubscribeFontSize);?>;'><font color='white'><?php print translate("subs_�dv�z�lj�k!") ?></font></td></tr>
<tr><td align='left' colspan='2' style='padding-bottom:10%;font-size:<?php print($SubscribeFontSize);?>;'><font color='white'><?php print translate("subs_K�rj�k, t�ltse ki adatait!") ?></td></tr>
<tr><td align='right' valign='center' style='font-size:<?php print($SubscribeFontSize);?>;'><font color='white'><?php print translate("subs_Vezet�kn�v") ?>* </td><td><input type='text' size='12' name='firstname' style='font-size:<?php print($SubscribeFontSize);?>;' value=<?php print "'{$_POST['firstname']}'"; ?>></td></tr>
<tr><td align='right' valign='center' style='20px;font-size:<?php print($SubscribeFontSize);?>;'><font color='white'><?php print translate("subs_Keresztn�v") ?>* </td><td><input type='text' size='12' name='secondname' style='font-size:<?php print($SubscribeFontSize);?>;' value=<?php print "'{$_POST['secondname']}'"; ?>></td></tr>
...
<tr><td align='right' valign='center' style='20px;font-size:<?php print($SubscribeFontSize);?>;'><font color='white'><?php print translate("subs_Jelsz�") ?>* </td><td><input type='text' size='12' name='login' style='font-size:<?php print($SubscribeFontSize);?>;' value=<?php print "'{$_POST['login']}'"; ?>></td></tr>

<?php if($_SESSION['page_nyelv'] == 0){ ?>
<tr>
    <td align='right' style='font-size:<?php print($SubscribeFontSize);?>;'><font color='white'><?php print translate("subs_Tanuland� nyelv") ?>* </td>
    <td>
